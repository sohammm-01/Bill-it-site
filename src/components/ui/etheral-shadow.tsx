...
// ============================================================
// Etheral Shadow — animated wobbling shadow via SVG filter
// (feTurbulence + feDisplacementMap + hue-rotate loop).
// Original component from 21st.dev. The only edit here is
// that the hardcoded "Etheral Shadows" h1 has been removed so
// this can be used purely as a background.
// ============================================================
